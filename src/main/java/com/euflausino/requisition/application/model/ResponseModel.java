...
public class ResponseModel {
    ...
    public ResponseModel(Integer status, String statusText, Boolean successful, Map<String, List<String>> headers, String body, Long responseTimeMs, Long sizeBytes, Long headersSizeBytes) {
        this.status = status;
